Release 0.9.0.2 (March 29, 2018)
================================

Highlights
----------
- Improved Initialize Feed NiFi Processor performance
...
Upgrade Instructions from v0.9.x
--------------------------------
...
.. |JIRA_Issues_Link| raw:: html
   ...
   <a href="https://kylo-io.atlassian.net/issues/?jql=project%20%3D%20KYLO%20AND%20status%20%3D%20Done%20AND%20fixVersion%20%3D%200.9.0.2%20ORDER%20BY%20summary%20ASC%2C%20lastViewed%20DESC" target="_blank">Jira Issues</a>
